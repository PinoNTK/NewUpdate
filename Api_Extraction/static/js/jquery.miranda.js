$.fn.mirandajs = function(data, options) {
    ...
    // Lỗi xử lý trong tham số đi qua
    ...
    // Nhận danh sách JSON chính xác và tương tác với điểm đến
    function mirandaParse(JSON, jsonNode){
        ...
        /* Se ainda tiver nodes para processar, faz a recursividade passando para o próximo índice */
         // Nếu bạn vẫn có các nút để xử lý, hãy thực hiện đệ quy vào chỉ mục kế tiếp
    ...
    // Thay thế chìa khóa cho các giá trị
